...
const handlePaymentCancel = (data, shouldRedirect = false) => {
  ...
  if (shouldRedirect) {
    ...
    // No need to set the payment cancelled state since we're redirecting
    console.log("Clearing cart and checkout data due to payment cancellation");
    
    // Clear form data from localStorage
    // localStorage.removeItem('measurements');
    // localStorage.removeItem('deliveryDetails');
    
    // The redirect will be handled by the PayPalPayment component
  } else {
    // For cases where we don't redirect (e.g., API errors)
    setPaymentCancelled(true);
