...
// // Load PayPal script
// export function loadPayPal(force = false) {
//   // Перевіряємо, чи скрипт уже підключений
//   const existingScript = document.querySelector('script[src*="paypal.com/sdk/js"]');
//   if (existingScript) {
//     if (force) {
//       existingScript.remove(); // видаляємо старий
//     } else {
//       // Якщо вже є і не форсуємо, одразу кажемо що завантажено
//       window.dispatchEvent(new Event('paypalLoaded'));
//       return;
//     }
//   }
